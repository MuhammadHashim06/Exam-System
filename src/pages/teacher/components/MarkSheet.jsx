    ...
    <div className="h-4/5 overflow-y-auto">
      ...
      {showModal && selectedStudent && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-3/4 max-w-3xl max-h-[80vh] overflow-y-auto relative">
            <h2 className="text-2xl font-bold mb-4">
              {selectedStudent.studentName}'s Answers
            </h2>
              ...
              <tbody>
                {selectedStudent.answers?.map((ans, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="border p-2">{ans.answer}</td>
                    <td className="border p-2 text-center">{ans.obtainMarks}</td>
                    <td className="border p-2 text-center">{ans.marks}</td>
                  </tr>
                ))}
              </tbody>
            </table>
